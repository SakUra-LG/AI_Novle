...
- 全书从前到后的核心类型必须始终是「重生 + 复仇 + 爽感」，尤其是 50 章之后，也要围绕仇人清算、真相揭露和情绪上的大爽展开，避免变成单纯的都市职场/商业成功记叙。
...
def generate_outline_rebirth_revenge():
    ...
    user_query = (
        ...
        "中后段可以使用「第7-17章 对敌人的第一次反击」这类阶段形式来概括一整段对敌行动，"
        "而不是每一章都变成完全独立的小故事；直到大结局之前，都要紧紧围绕重生复仇主线，"
        "不要写成单纯的都市职场/商业成功故事。"
    )
