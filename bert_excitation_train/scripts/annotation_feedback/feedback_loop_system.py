...
class FeedbackLoopSystem:
    def __init__(self):
        ...
        self.feedback_file = 'work_outputs/feedback_log.csv'
    ...
    def update_rag_samples(self, min_score=70):
        ...
        # 读取现有RAG样本
        rag_file = 'bert_excitation_train/data/universal_samples.txt'
        ...
        for _, row in high_score_samples.iterrows():
            # 读取生成的内容
            content_file = f"bert_excitation_train/data/generated/暗河噬城/{row['candidate_file']}"
