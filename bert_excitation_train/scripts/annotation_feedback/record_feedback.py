...
def record_feedback(chapter_num, candidates_dir, feedback_csv="work_outputs/feedback_log.csv"):
    """记录章节反馈"""
...
def analyze_feedback(feedback_csv="work_outputs/feedback_log.csv"):
    """分析反馈数据"""
