...
def prepare_generation_training_data():
    ...
    gen_file = "data/training/generation_training_data.jsonl"
...
def retrain_generation_model():
    ...
    existing_file = "data/training/lora_data.jsonl"
    existing_data = []
    ...
    # Save merged data
    merged_file = "data/training/merged_generation_data.jsonl"
    ...
    try:
        result = subprocess.run([
            ...
            '--output_dir', 'checkpoints/lora_model_high_score',
            '--epochs', '3'
