...
def prepare_training_data_from_feedback(feedback_csv="work_outputs/feedback_log.csv",
                                      output_file="bert_excitation_train/data/training/high_quality_training_data.csv",
    ...
    for _, row in high_quality.iterrows():
        # 读取完整内容
        content_file = f"bert_excitation_train/data/candidates/{row['candidate_file']}"
...
def prepare_training_data_from_samples(samples_file="bert_excitation_train/data/universal_samples.txt",
                                     output_file="bert_excitation_train/data/training/sample_training_data.csv",
...
def combine_training_data(feedback_data_file="bert_excitation_train/data/training/high_quality_training_data.csv",
                         sample_data_file="bert_excitation_train/data/training/sample_training_data.csv",
                         output_file="bert_excitation_train/data/training/combined_training_data.csv"):
    """合并训练数据"""
...
def main():
    ...
    parser.add_argument('--feedback_csv', type=str, default='work_outputs/feedback_log.csv', help='反馈文件路径')
    parser.add_argument('--samples_file', type=str, default='bert_excitation_train/data/universal_samples.txt', help='样本文件路径')
