...
class IncrementalModelTrainer:
    def __init__(self):
        self.ml_incremental_file = "bert_excitation_train/data/training/incremental_ml_annotations.json"
        self.gen_incremental_file = "bert_excitation_train/data/training/incremental_generation_data.jsonl"
        self.ml_full_file = "bert_excitation_train/data/training/paragraph_annotations.json"
        self.gen_full_file = "bert_excitation_train/data/training/lora_data.jsonl"
        self.training_log = "bert_excitation_train/data/training/training_log.json"
    ...
    def train_lora_incremental(self):
        ...
        try:
            ...
            cmd = [
                ...
                "--output_dir", "bert_excitation_train/checkpoints/lora_model_incremental",
    ...
    def train_full_incremental(self):
        ...
        try:
            ...
            cmd = [
                ...
                "--data_file", self.gen_full_file,
                "--output_dir", "bert_excitation_train/checkpoints/finetuned_model_incremental",
