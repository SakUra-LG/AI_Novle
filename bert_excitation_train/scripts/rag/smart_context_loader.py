...
def load_generation_config(config_file: str = "bert_excitation_train/config/generation_config.json") -> Dict:
    """加载生成配置"""
...
def load_novel_context_smart(max_chapters: int = None, config_file: str = "bert_excitation_train/config/generation_config.json") -> Dict:
    """智能加载小说上下文信息"""
    ...
    # 动态读取章节正文
    chapters_dir = "bert_excitation_train/data/chapters"
...
def get_available_chapters(chapters_dir: str = "bert_excitation_train/data/chapters") -> List[int]:
    """获取所有可用的章节号"""
