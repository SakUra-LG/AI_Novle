...
def main():
    ...
    os.makedirs('bert_excitation_train/checkpoints/optimized_rule_scorer', exist_ok=True)
    with open('bert_excitation_train/checkpoints/optimized_rule_scorer/config.json', 'w', encoding='utf-8') as f:
