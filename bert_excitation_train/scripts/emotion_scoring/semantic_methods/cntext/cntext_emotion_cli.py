...
用法：
python -m bert_excitation_train.scripts.emotion_scoring.semantic_methods.cntext.cntext_emotion_cli --text "这里输入中文句子"
python -m bert_excitation_train.scripts.emotion_scoring.semantic_methods.cntext.cntext_emotion_cli
"""
