...
def save_scored_data(scored_sentences: List[Dict], output_file: str):
    ...
    output_file = f"bert_excitation_train/data/training/manual_scores_{timestamp}.json"
...
def main():
    ...
    # 保存评分数据
    output_file = save_scored_data(scored_sentences, "bert_excitation_train/data/training/manual_scores.json")
