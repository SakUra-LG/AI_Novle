...
from bert_excitation_train.scripts.rag.smart_sample_search import search_rebirth_samples_for_chapter
...
from bert_excitation_train.scripts.novel_generation_v2.qwen_transport import call_qwen_via_curl
...
def _configure_cli_utf8() -> None:
    """Use UTF-8 for the interactive CLI without mutating streams on import."""
    try:
...
def _sync_neo4j_from_outputs(
    *,
    ...
    from bert_excitation_train.scripts.knowledge_graph.bootstrap_neo4j import (
    ...
    from bert_excitation_train.scripts.knowledge_graph.story_identity import (
...
class RebirthRevengeGeneratorV2(_RebirthRevengeGeneratorV2Core):
    ...
    def attach_online_retriever(self) -> None:
        ...
        """
        try:
            from bert_excitation_train.scripts.knowledge_graph.online_retriever import retrieve_context_for_chapter  # type: ignore[import-not-found]
        except Exception:
            return
...
def _prior_current_right_keys(card: Dict[str, Any]) -> set[str]:
    from bert_excitation_train.scripts.knowledge_graph.chapter_memory import story_state_slot
...
def _commit_staged_cluster_delivery(
    ...
    """
    from bert_excitation_train.scripts.knowledge_graph.chapter_memory import content_hash
