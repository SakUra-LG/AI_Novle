...
# 允许直接 `python path/to/script.py` 运行时也能进行绝对导入
SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))
PROJECT_ROOT = os.path.dirname(os.path.dirname(os.path.dirname(SCRIPT_DIR)))
if PROJECT_ROOT not in sys.path:
    sys.path.insert(0, PROJECT_ROOT)

from bert_excitation_train.scripts.smart_sample_search import find_similar_samples, adapt_sample_content
from bert_excitation_train.scripts.paragraph_scorer import ParagraphScorer
