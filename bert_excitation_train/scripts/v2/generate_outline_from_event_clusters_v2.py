...
from bert_excitation_train.scripts.generate_outline_rebirth_revenge import (  # type: ignore[import]
...
def generate_outline_from_event_clusters_v2() -> None:
    ...
    for batch_idx in range(0, 100, batch_size):
        ...
        from bert_excitation_train.scripts.generate_outline_rebirth_revenge import call_qianwen_api as _call_qw  # type: ignore[import]
